...
SAME_LENGTH_DIR = Path(__file__).resolve().parent
sys.path.insert(0, str(SAME_LENGTH_DIR))

import Archive.Figure_same_length.same_length_common as common  # noqa: E402


SCRIPTS = [
    common.FIGURE_3_DIR / "make_figure_3_panels_same_length.py",
    common.FIGURE_SCHEME_DIR / "make_edl_vs_no_edl_bv_mixed_potential_with_pzc_same_length.py",
    common.FIGRUE_RP_DIR / "make_phi_s_reactants_2d_same_length.py",
]
