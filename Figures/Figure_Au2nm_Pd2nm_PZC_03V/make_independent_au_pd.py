...
STUDY_ID = "independent_Au2nm_Pd2nm_CH50_PZC03V"
...
EXPECTED_RESULTS: dict[str, dict[str, tuple[float, float]]] = {
    "with_edl": {
        "E_mix_V": (0.5918979952021372, 5.0e-11),
        "i_mix_avg_A_per_m2": (0.015838438113541905, 5.0e-12),
        "i_mix_abs_A": (6.335375245416762e-13, 5.0e-22),
    },
    "without_edl": {
