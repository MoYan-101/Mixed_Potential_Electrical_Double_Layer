...
OUTPUT_TAG = f"au2_pd2_pzc03V_{BASE_RESULT_ID}"
...
def _validate_legacy_parameters(cases: list[LegacyCase]) -> None:
    ...
    locked = {
        ...
        "Cdl_C": 0.20,
        "Cdl_Pd": 0.50,
        "pzc_Au": 0.9238855001102359,
        "pzc_Pd": 0.6238855001102359,
...
def summary_row(case: LegacyCase) -> dict[str, Any]:
    ...
    return {
        ...
        "PZC_Au_SHE_V": 0.51,
        "PZC_Pd_SHE_V": 0.21,
        "PZC_Au_RHE_V": float(case.params["pzc_Au"]),
        "PZC_Pd_RHE_V": float(case.params["pzc_Pd"]),
        "PZC_difference_V": float(case.params["pzc_Au"] - case.params["pzc_Pd"]),
